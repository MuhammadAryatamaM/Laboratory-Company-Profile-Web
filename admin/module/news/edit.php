...
if (!$item) {
  echo "<script>alert('News item not found.'); window.location='index.php?page=news';</script>";
  exit();
}
      ...
      <div class="col-lg-8">
        <div class="card border-0 shadow-sm">
          <div class="card-body">
            ...
            <form method="POST" action="module/news/aksi.php?module=news&act=update" enctype="multipart/form-data">
              <input type="hidden" name="id" value="<?php echo $item['news_id']; ?>">

              <div class="mb-4">
                <label for="title" class="form-label">Title <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="title" name="title" placeholder="Enter news title" value="<?php echo htmlspecialchars($item['title']); ?>" required>
              </div>
              ...
              <div class="mb-4">
                ...
                <div class="upload-area-news border-2 border-dashed rounded-3 p-5 text-center" style="cursor: pointer; border-color: #e0e0e0; transition: all 0.3s;">
                  ...
                  <p class="mb-2">Drag & drop to replace image or</p>
                  <button type="button" class="btn btn-sm btn-outline-primary">Upload New Image</button>
                  ...
                  <?php if ($item['image_url']) : ?>
                    <p class="mt-2">Current image: <a href="../assets/uploads/<?php echo $item['image_url']; ?>" target="_blank"><?php echo $item['image_url']; ?></a></p>
                    <img src="../assets/uploads/<?php echo $item['image_url']; ?>" alt="Current Image" style="max-height: 100px; margin-top: 10px;">
                  <?php endif; ?>
                </div>
              </div>
              ...
              <div class="row">
                  ...
                  <div class="mb-4">
                    ...
                    <select class="form-select" id="author" name="author_id" required>
                      ...
                      <?php foreach ($authors as $author) : ?>
                        <option value="<?php echo $author['member_id']; ?>" <?php echo ($item['author_id'] == $author['member_id']) ? 'selected' : ''; ?>>
                ...
                <div class="col-md-4">
                  <div class="mb-4">
                    ...
                    <input type="text" class="form-control" id="place" name="place" placeholder="e.g. Tokyo" value="<?php echo htmlspecialchars($item['place'] ?? ''); ?>">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="mb-4">
                    <label for="tag" class="form-label">Tag (Category)</label>
                    <input type="text" class="form-control" id="tag" name="tag" placeholder="e.g. Conference" value="<?php echo htmlspecialchars($item['tag'] ?? 'General'); ?>">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="mb-4">
                    ...
                    <input type="date" class="form-control" id="date" name="publish_date" value="<?php echo $item['publish_date']; ?>" required>
                  </div>
                </div>
              </div>

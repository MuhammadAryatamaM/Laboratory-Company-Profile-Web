...
<nav class="navbar navbar-light bg-white border-bottom shadow-sm sticky-top">
  <div class="container-fluid d-flex justify-content-between align-items-center">
    <?php if (isset($_SESSION['role']) && $_SESSION['role'] == 'Kepala Laboratorium') : ?>
      <h5 class="mb-0">Welcome to CMS Superadmin</h5>
    <?php else : ?>
      <h5 class="mb-0">Welcome to CMS Admin</h5>
    <?php endif; ?>
    <div class="d-flex align-items-center gap-3">
      <div class="position-relative">
        <a href="index.php?page=message" class="btn btn-link position-relative text-dark text-decoration-none">
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end shadow-sm" aria-labelledby="profileDropdown">
          <li><a class="dropdown-item" href="?page=teams"><i class="fas fa-user me-2"></i> Profile</a></li>
          <?php if (isset($_SESSION['role']) && $_SESSION['role'] == 'Kepala Laboratorium') : ?>
